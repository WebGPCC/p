        ...
        <div className="flex mt-[-60px] items-center overflow-hidden text-[100px] lg:text-[130px] "> 
            <div className="whitespace-nowrap font-bold rollingText">
                <div className="rightToLeft flex gap-2 ">
                    <p className="mb-0">Software Development<span className="text-[#C0E8DA] opacity-50">·</span>Branding<span className="text-[#C0E8DA] opacity-50">·</span>Development<span className="text-[#C0E8DA] opacity-50">·</span></p>
                    <p className="mb-0">Software Development<span className="text-[#C0E8DA] opacity-50">·</span>Branding<span className="text-[#C0E8DA] opacity-50">·</span>Development<span className="text-[#C0E8DA] opacity-50">·</span></p>
                </div>
            </div>
        </div>
